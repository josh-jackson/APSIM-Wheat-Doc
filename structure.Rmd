...
Although the the non-linear reponse of temperature on phyllchron were observed by Friend et al. [-@friend_leaf_1962]  and Cao and Moss [-@cao_temperature_1989]. A simple linear reponse of phyllochron to temperature is used as this model works surprusingly well in predicting phyllochron for most field conditions [@mcmaster_re-examining_2003]. The accuracy could be reduced in special conditions (e.g. shorter linear phase, linear phase not correlated with field temperatures, response to high temperatures differs, etc.) @mcmaster_re-examining_2003.


Based on [@jamieson_sirius:_1998], leaf appearace could be described by a base phyllochron determined between leaves 2 and 7 and a phyllochron that was 70% of base phyllochron for leaves < 2 and 130% of base phyllochron for leaves > 7. The base phyllochron set as 100 <sup>o</sup>Cd.

```{block, type='rmdimportant', echo=TRUE}
I didn't find the description of phyllochorn in Jamieson (1998).
```
