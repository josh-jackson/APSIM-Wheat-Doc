...
As the primary bud number is equal to 1, the plant total node number and total primary node number are the same (Figure \@ref(fig:plant-node-number)). 

<div class="fig-output">
```{r plant-node-number, fig.cap='The fraction of nitrogen supply relative to nitrogen demand'}
