...
'Wheat.Leaf.LAITotal')
x_var <- 'Wheat.Phenology.Stage'
plot_report(df, x_var, y_cols, x_lab = 'Stage', y_lab = 'Leaf area index')


x_var <- 'Wheat.Phenology.AccumulateThermalTime'
plot_report(df, x_var, y_cols, x_lab = 'Accumulated thermal time', 
...
x_var <- 'Wheat.Phenology.Stage'
plot_report(df, x_var, y_cols, x_lab = 'Stage', y_lab = 'Coverage')
