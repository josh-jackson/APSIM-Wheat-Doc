...
```{r size-function, fig.asp=-.75, fig.cap='The size function of leaf area development'}
...
The daily potential increase of leaf area is calculated by changes of daily thermal time and leaf size function. 


Drought accelates leaf development through accelating daily thermal time.  
